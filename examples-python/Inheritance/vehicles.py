...
class Automobile:
    ...
    def __str__(self):
        return "Make:  {}  Model:  {}  Milage:  {}  Price:  {}".format(self.get_make(), self.get_model(), self.get_mileage() , self.get_price())
...
class Car(Automobile):
    ...
    def __str__(self):
        return super().__str__() + ' Doors: {}'.format(self.get_doors())
...
class Truck(Automobile):
    ...
    def __str__(self):
        return super().__str__() + ' Drivetype: {}'.format(self.get_drive_type())
...
class SUV(Automobile):
    ...
    def __str__(self):
        return super().__str__() + ' Number of passengers: {}'.format(self.get_pass_cap())